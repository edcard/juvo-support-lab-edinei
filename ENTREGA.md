...
Liste os **12 tickets** na ordem de atendimento (use os IDs [IT-2001](./tickets/IT-2001.md) … [IT-2012](./tickets/IT-2012.md)).

Para cada um, **2-4 linhas**: impacto, resolve no suporte / orienta CX / escala.

Se agrupou tickets do mesmo cliente (ex.: [IT-2008](./tickets/IT-2008.md) e [IT-2011](./tickets/IT-2011.md)), explique aqui.
